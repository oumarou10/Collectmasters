...
class Item extends \AppBundle\Entity\Item implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'collection', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'imageUrl'];
        }
